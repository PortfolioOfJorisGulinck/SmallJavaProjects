...
public class Judoka implements Comparable<Judoka>, Serializable{
    private int id;
    private String naam;
    ...
    public Judoka(int id, String naam, Geslacht geslacht, LocalDate geboorte, int gewicht, Medaille medaille, Kampioenschap kampioenschap) {
        this.id = id;
    ...
    public Judoka(String naam, Geslacht geslacht, LocalDate geboorte, int gewicht, Medaille medaille, Kampioenschap kampioenschap) {
        this(-1, naam, geslacht, geboorte, gewicht, medaille, kampioenschap);
    }
